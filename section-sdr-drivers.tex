...
The tone amplitudes are not the output power, which also depends on the attenuation of the transmit path. This is the
Attenuation setting of the transmit channel, in dB (0 dB is the most output power), and applies to both tones.
